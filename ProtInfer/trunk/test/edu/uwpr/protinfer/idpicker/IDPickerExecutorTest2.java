...
public class IDPickerExecutorTest2 extends TestCase {
    ...
    public final void testInferProteins() {
        ...
        // CHECK THE CLUSTERS
        // proteins 1, 2, and 3 should be in the same cluster
        ...
        assertEquals(clusterId1, map.get("protein_3").getProteinClusterId());
        ...
        // protein_5
        int groupId3 = map.get("protein_3").getProteinGroupId();
        ...
        assertEquals(4, prot.getPeptides().size());
    ...
    private List<PeptideSpectrumMatchIDP> makeSearchHits() {
        ...
        Protein[] proteins = new Protein[4];
        ...
        int proteinId = 1;
        int scanId = 1;
        // peptide_1: matches protein 1, 3
        addSearchHits(proteinId++, hits, source, scanId, new Protein[]{proteins[1], proteins[3]});
        
        // peptide_2: matches protein 1, 2
        addSearchHits(proteinId++, hits, source, scanId+=2, new Protein[]{proteins[1], proteins[2]});
        
        // peptide_3: matches protein 2
        addSearchHits(proteinId++, hits, source, scanId+=2, new Protein[]{proteins[2]});
        
        // peptide_4: matches protein 2
        addSearchHits(proteinId++, hits, source, scanId+=2, new Protein[]{proteins[2]});
        
        // peptide_5: matches protein 1, 3
        addSearchHits(proteinId++, hits, source, scanId+=2, new Protein[]{proteins[1], proteins[3]});
        
        // peptide_6: matches protein 1, 2, 3
        addSearchHits(proteinId++, hits, source, scanId+=2, new Protein[]{proteins[1], proteins[2], proteins[3]});
