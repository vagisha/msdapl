...
import org.yeastrc.conversion.populate_qc_plots.db.DBConnectionBatch;
...
public class Main {
	...
	public static void main(String[] args) throws IOException {
		...
		DBConnectionBatch dbConnectionBatch = new DBConnectionBatch();
		
		DBConnectionManager.setDbConnectionManagerIF(dbConnectionBatch);
