...
--
-- Host: localhost    Database: msData_repoman
-- ------------------------------------------------------
...
CREATE TABLE `IDPickerParam` (
  ...
  PRIMARY KEY (`id`),
  KEY `piRunID` (`piRunID`)
) ENGINE=MyISAM AUTO_INCREMENT=22738 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `MS2FileChargeIndependentAnalysis` (
  ...
  PRIMARY KEY (`id`),
  KEY `scanID` (`scanID`)
) ENGINE=MyISAM AUTO_INCREMENT=265617414 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `MS2FileScanCharge` (
  ...
  PRIMARY KEY (`id`),
  KEY `scanID` (`scanID`)
) ENGINE=MyISAM AUTO_INCREMENT=102236272 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER MS2FileScanCharge_bdelete BEFORE DELETE ON MS2FileScanCharge
 FOR EACH ROW
 BEGIN
...
CREATE TABLE `PercolatorResult` (
  ...
  KEY `resultID` (`resultID`)
) ENGINE=MyISAM AUTO_INCREMENT=121601724 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=MyISAM AUTO_INCREMENT=85956 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `SQTParams` (
  ...
  PRIMARY KEY (`id`),
  KEY `searchID` (`searchID`,`param`)
) ENGINE=MyISAM AUTO_INCREMENT=38350 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `SQTSpectrumData` (
  ...
  KEY `scanID` (`scanID`,`runSearchID`)
) ENGINE=MyISAM AUTO_INCREMENT=125458878 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER msDigestionEnzyme_bdelete BEFORE DELETE ON msDigestionEnzyme
 FOR EACH ROW
 BEGIN
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER msExperiment_bdelete BEFORE DELETE ON msExperiment
 FOR EACH ROW
 BEGIN
...
CREATE TABLE `msProteinInferInput` (
  ...
  KEY `piRunID` (`piRunID`),
  KEY `inputID` (`inputID`)
) ENGINE=MyISAM AUTO_INCREMENT=13620 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER msProteinInferInput_bdelete BEFORE DELETE ON msProteinInferInput
 FOR EACH ROW
 BEGIN
...
) ENGINE=MyISAM AUTO_INCREMENT=9903689 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`vsharma`@`localhost`*/ /*!50003 TRIGGER msProteinInferIon_bdelete BEFORE DELETE ON msProteinInferIon
 FOR EACH ROW
 BEGIN
...
CREATE TABLE `msProteinInferPeptide` (
  ...
  PRIMARY KEY (`id`),
  KEY `piRunID` (`piRunID`)
) ENGINE=MyISAM AUTO_INCREMENT=8674163 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER msProteinInferPeptide_bdelete BEFORE DELETE ON msProteinInferPeptide
 FOR EACH ROW
 BEGIN
...
CREATE TABLE `msProteinInferProtein` (
  ...
  KEY `nrseqProteinID_3` (`nrseqProteinID`,`piRunID`)
) ENGINE=MyISAM AUTO_INCREMENT=4144646 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
...
CREATE TABLE `msProteinInferRun` (
  ...
  `comments` tinytext,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=2845 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
...
CREATE TABLE `msProteinInferSpectrumMatch` (
  ...
  PRIMARY KEY (`id`),
  KEY `runSearchResultID` (`resultID`),
  KEY `piIonID` (`piIonID`),
  KEY `resultID` (`resultID`)
) ENGINE=MyISAM AUTO_INCREMENT=48843759 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER msProteinInferSpectrumMatch_bdelete BEFORE DELETE ON msProteinInferSpectrumMatch
 FOR EACH ROW
 BEGIN
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER msRun_bdelete BEFORE DELETE ON msRun
 FOR EACH ROW
 BEGIN
...
) ENGINE=MyISAM AUTO_INCREMENT=3891 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
...
CREATE TABLE `msRunSearchAnalysis` (
  ...
  KEY `searchAnalysisID` (`searchAnalysisID`),
  KEY `runSearchID` (`runSearchID`)
) ENGINE=MyISAM AUTO_INCREMENT=3721 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
...
) ENGINE=MyISAM AUTO_INCREMENT=421789502 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
...
) ENGINE=MyISAM AUTO_INCREMENT=51035990 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER msScan_bdelete BEFORE DELETE ON msScan
 FOR EACH ROW
 BEGIN
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER msSearchDynamicMod_bdelete BEFORE DELETE ON msSearchDynamicMod
 FOR EACH ROW
 BEGIN
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER msSearchTerminalDynamicMod_bdelete BEFORE DELETE ON msSearchTerminalDynamicMod
 FOR EACH ROW
 BEGIN
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER msSequenceDatabaseDetail_bdelete BEFORE DELETE ON msSequenceDatabaseDetail
 FOR EACH ROW
 BEGIN
...
-- Dump completed on 2010-03-19 12:11:49
