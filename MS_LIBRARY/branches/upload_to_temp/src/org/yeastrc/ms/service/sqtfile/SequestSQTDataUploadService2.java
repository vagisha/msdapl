/**
 * SequestSQTDataUploadService2.java
 ...
 * 
 */
public class SequestSQTDataUploadService2 extends AbstractSQTDataUploadService {
    ...
    public SequestSQTDataUploadService2(SearchFileFormat format) {
        super();
        this.format = format;
...
//        lastUploadedRunSearchId = 0;
    ...
    private int uploadSequestSqtFile(SequestSQTFileReader provider, int searchId, int runId, int searchDbId) throws UploadException {
        ...
        List<SequestSearchResultBean> results = new ArrayList<SequestSearchResultBean>(RESULT_BUF_SIZE);
...
//    }
    ...
    void uploadSearchResults(List<SequestSearchResultBean> results) throws UploadException {
        
        List<Integer> resultIds = super.uploadBaseSearchResults(results);
        for(int i = 0; i < results.size(); i++) {
            SequestSearchResultBean result = results.get(i);
