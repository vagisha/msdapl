 ...
 * 
 */
public class ProlucidSearchUploadDAOIbatisImpl extends BaseSqlMapDAO implements ProlucidSearchUploadDAO {

    
    private MsSearchUploadDAO searchDao;
    
    public ProlucidSearchUploadDAOIbatisImpl(SqlMapClient sqlMap, MsSearchUploadDAO searchDao) {
        super(sqlMap);
