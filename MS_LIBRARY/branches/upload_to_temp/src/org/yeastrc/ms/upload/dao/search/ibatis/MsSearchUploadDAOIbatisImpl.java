/**
 * MsSearchUploadDAOIbatisImpl.java
 ...
 * 
 */
public class MsSearchUploadDAOIbatisImpl extends BaseSqlMapDAO implements MsSearchUploadDAO {
    ...
    public MsSearchUploadDAOIbatisImpl(SqlMapClient sqlMap, 
            MsSearchDatabaseUploadDAO seqDbDao,
            MsSearchModificationUploadDAO modDao,
            MsEnzymeUploadDAO enzymeDao) {
        super(sqlMap);
