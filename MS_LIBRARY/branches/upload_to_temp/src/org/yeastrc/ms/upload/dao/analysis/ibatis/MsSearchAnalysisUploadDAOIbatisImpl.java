...
public class MsSearchAnalysisUploadDAOIbatisImpl extends BaseSqlMapDAO implements MsSearchAnalysisUploadDAO {

    private static final String namespace = "MsSearchAnalysis";
    
    
    public MsSearchAnalysisUploadDAOIbatisImpl(SqlMapClient sqlMap) {
        super(sqlMap);
    }
