...
<logic:empty name="filterForm">
  <logic:forward name="viewXtandemResults" />
</logic:empty>
...
<yrcwww:contentbox title="X!Tandem Results" centered="true" width="95" widthRel="true">
<center>
	...
	<!-- FILTER FORM -->
	<%@ include file="xtandemFilterForm.jsp" %>
	...
	<yrcwww:table name="results" tableId='xtandem_results' tableClass="table_basic sortable_table" center="true" />
	</div>
