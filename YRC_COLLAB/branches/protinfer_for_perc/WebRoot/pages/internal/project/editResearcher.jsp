...
<logic:notPresent name="editInformationForm" scope="request">
 <logic:forward name="editResearcher"/>
</logic:notPresent>
...
<yrcwww:contentbox title="Edit Researcher Information" centered="true" width="600">
 <CENTER>
  <html:form action="saveEditResearcher" method="post">
