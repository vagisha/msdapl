...
<yrcwww:contentbox title="View Technology Development Details" centered="true" width="750">
...
<SCRIPT LANGUAGE="JavaScript">
 ...
 <TABLE CELLPADDING="no" CELLSPACING="0">
  ...
  <yrcwww:colorrow>
   ...
   <TD valign="top" width="75%"><bean:write name="project" property="fundingTypes"/>
  </yrcwww:colorrow>

  <yrcwww:colorrow>
   <TD valign="top" width="25%">Federal Funding:</TD>
   <TD valign="top" width="75%"><bean:write name="project" property="federalFundingTypes"/>
  </yrcwww:colorrow>
  ...
  <yrcwww:colorrow>
   ...
   <TD valign="top" width="75%"><bean:write name="project" property="abstractAsHTML" filter="false"/>
  </yrcwww:colorrow>

  <yrcwww:colorrow>
   <TD valign="top" width="25%">Public Abstract:</TD>
   <TD valign="top" width="75%"><bean:write name="project" property="publicAbstractAsHTML" filter="false"/>
  </yrcwww:colorrow>

  <yrcwww:colorrow>
   <TD valign="top" width="25%">Progress/Results:</TD>
   <TD valign="top" width="75%"><bean:write name="project" property="progressAsHTML" filter="false"/>
  </yrcwww:colorrow>

  <yrcwww:colorrow>
   <TD valign="top" width="25%">Publications:</TD>
   <TD valign="top" width="75%"><bean:write name="project" property="publicationsAsHTML" filter="false"/>
  </yrcwww:colorrow>
