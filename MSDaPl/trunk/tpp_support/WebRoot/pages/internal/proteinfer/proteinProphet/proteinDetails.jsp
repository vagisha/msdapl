...
<tr class="pinfer_A">
	...
	<td>Subsumed</td>
	<logic:equal name="protein" property="protein.isParsimonious" value="false">
		<td>Subsuming Protein(s)</td>
	</logic:equal>
	<logic:present name="subsumedProteins">
		<td>Subsumed Protein(s)</td>
	</logic:present>
...
<tr>
	...
	<td style="border: 1px #CCCCCC dotted;" align="center">
		<logic:equal name="protein" property="protein.isParsimonious" value="true">No</logic:equal>
		<logic:equal name="protein" property="protein.isParsimonious" value="false">Yes</logic:equal>
	</td>
	
	<!-- SUBSUMING PROTEINS -->
	<logic:equal name="protein" property="protein.isParsimonious" value="false">
		<td valign="top">
			<logic:iterate name="subsumingProteins" id="prot">
	...
	<logic:present name="subsumedProteins">
		<td valign="top">
			<logic:iterate name="subsumedProteins" id="prot">
				<span onclick="showProteinDetails(<bean:write name="prot" property="protein.id" />)" 
						style="text-decoration: underline; cursor: pointer">
				<li>
					<logic:iterate name="prot" property="proteinListing.fastaReferences" id="reference" indexId="index">
	...
	<td style="border: 1px #CCCCCC dotted; text-align: left;" align="center" valign="top">
